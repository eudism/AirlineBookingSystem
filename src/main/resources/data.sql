INSERT  INTO airport(code, location, name) VALUES ('CDA', '12 Brookhust Str, Cedar Rapids, IA', 'Cedar Rapids Airport');
INSERT  INTO airport(code, location, name) VALUES ('SNA', '111 First Str, Santa Anna, CA', 'John Wayne Airport');
