package cs.cs489.project.airlinebookingsystem.filter;

import cs.cs489.project.airlinebookingsystem.serviceImpl.AirlineUserDetailsService;
import cs.cs489.project.airlinebookingsystem.utils.service.JWTManagementUtilityService;
...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    public JWTAuthFilter(AirlineUserDetailsService airlineUserDetailsService,
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(username != null
            ...
            UserDetails userDetails = airlineUserDetailsService.loadUserByUsername(username);
